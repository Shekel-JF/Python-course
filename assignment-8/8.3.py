...
# date_time = Label(...
date_label = Label(okno, textvariable = date_time, font = ("Times New Roman", 30), bg = 'black', fg = 'white', width = 400, pady = 100)
...
# utwórz cal = Calendar(...
calendar = Calendar(okno, font = ("Times New Roman", 12), selectmode = 'day', year = year, month = month, day = day)
